...
const countryController = container_1.default.resolve("countryController");
/**
 * @swagger
 * /countries:
 *   post:
 ...
 */
router.post("/", auth_1.authenticateJWT, (req, res) => countryController.createCountry(req, res));
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.get("/active", (req, res) => countryController.getActiveCountries(req, res));
/**
 * @swagger
 * /countries/{id}:
 *   get:
...
router.put("/:id", auth_1.authenticateJWT, (req, res) => countryController.updateCountry(req, res));
router.delete("/:id", auth_1.authenticateJWT, (req, res) => countryController.deleteCountry(req, res));
/**
 * @swagger
 * /countries/code/{code}:
 *   get:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.get("/code/:code", (req, res) => countryController.getCountryByCode(req, res));
