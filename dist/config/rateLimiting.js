...
exports.rateLimitEnvironment = exports.getRateLimitForEndpoint = exports.rateLimitConfig = exports.getRateLimitConfig = void 0;
/**
 ...
 */
exports.rateLimitConfig = (0, exports.getRateLimitConfig)();
/**
 * Helper function to get rate limit config for a specific endpoint
 */
const getRateLimitForEndpoint = (endpointType) => {
    return exports.rateLimitConfig[endpointType];
};
exports.getRateLimitForEndpoint = getRateLimitForEndpoint;
/**
 * Environment information for logging/debugging
 */
exports.rateLimitEnvironment = {
    isTest: isTestEnv,
