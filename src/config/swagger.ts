...
const swaggerDefinition: SwaggerDefinition = {
      ...
      ServiceProvider: {
        ...
        properties: {
          ...
          supportedCountries: {
            ...
            description:
              "List of supported countries for this service provider",
          },
          createdAt: {
            type: "string",
            format: "date-time",
      ...
      CreateServiceProviderRequest: {
        ...
        properties: {
          ...
          supportedCountryIds: {
            ...
            description:
              "Array of country IDs that this service provider supports",
          },
        },
        required: ["name"],
      },
      ...
      Country: {
        ...
        properties: {
          ...
          numericCode: {
            ...
            pattern: "^\\d{3}$",
            description:
              "ISO 3166-1 numeric country code (e.g., 840, 826, 124)",
            nullable: true,
          },
          continent: {
            type: "string",
      ...
      CreateCountryRequest: {
        ...
        properties: {
          ...
          code: {
            ...
            pattern: "^[A-Z]{2}$",
            description:
              "ISO 3166-1 alpha-2 country code (required, 2 uppercase letters)",
          },
          alpha3: {
            type: "string",
            pattern: "^[A-Z]{3}$",
            description:
              "ISO 3166-1 alpha-3 country code (required, 3 uppercase letters)",
          },
          numericCode: {
            type: "string",
            pattern: "^\\d{3}$",
          ...
          currency: {
            ...
            pattern: "^[A-Z]{3}$",
            description:
              "ISO 4217 currency code (optional, 3 uppercase letters)",
          },
          phoneCode: {
            type: "string",
            pattern: "^\\+\\d{1,4}$",
            description:
              "International phone code (optional, format: +X to +XXXX)",
          },
          isActive: {
            type: "boolean",
            description:
              "Whether the country is active (optional, defaults to true)",
            default: true,
          },
        },
      ...
      CreateCurrencyRequest: {
        ...
        properties: {
          ...
          code: {
            ...
            pattern: "^[A-Z]{3}$",
            description:
              "ISO 4217 currency code (required, 3 uppercase letters)",
          },
          symbol: {
            type: "string",
            maxLength: 5,
          ...
          minorUnit: {
            ...
            maximum: 6,
            description:
              "Number of decimal places (optional, 0-6, defaults to 2)",
            default: 2,
          },
          isActive: {
            type: "boolean",
            description:
              "Whether the currency is active (optional, defaults to true)",
            default: true,
          },
        },
        required: ["name", "code"],
  ...
  tags: [
    ...
    },
    {
      name: "Countries",
      description:
        "Country management with ISO codes and geographic information",
    },
    {
      name: "Currencies",
      description:
        "Currency management with ISO 4217 codes and formatting information",
    },
  ],
};
